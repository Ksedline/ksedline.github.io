...
var ThreeComponent = function ThreeComponent() {
  ...
  var onRefResized = function onRefResized(width, height) {
    console.log(_this);
  ...
  var appendCanvas = function appendCanvas(ref) {
    if (ref && renderer) {
      ...
      renderer.setSize(width, height);
      camera.setViewOffset(width, height, 0, 0, width, height);
      ref.appendChild(renderer.domElement); //ref.onresize = onRefResized.bind(this);

      ref.addEventListener('resize', onRefResized);
    }
  };
...
//# sourceMappingURL=index.js.e8e0a057c19179d786c7.hot-update.js.map